	...
	m_coreInput(nullptr)
{
	...
	m_main = std::unique_ptr<Bezier_surfaceMain>(new Bezier_surfaceMain(m_deviceResources));
...
void Bezier_surface::DirectXPage::OnPointerWheelChanged(Platform::Object^ sender, Windows::UI::Core::PointerEventArgs^ e)
{
